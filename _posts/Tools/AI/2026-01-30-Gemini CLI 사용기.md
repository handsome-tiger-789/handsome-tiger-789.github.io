...
![](/assets/img/Tools/AI/2026-01-30-img-gemini/gemini-cli.png) <br/>
...
![](/assets/img/Tools/AI/2026-01-30-img-gemini/gemini-code-1.png) <br/>
...
![](/assets/img/Tools/AI/2026-01-30-img-gemini/gemini-code-2.png) <br/>


이에 다시한번 수정을 명령한 결과 <br>

![](/assets/img/Tools/AI/2026-01-30-img-gemini/gemini-update-cli.png) <br/>


![](/assets/img/Tools/AI/2026-01-30-img-gemini/gemini-error-package.png) <br/>

패키지 구조는 보기 좋게 정리 되었으나 <br>



![](/assets/img/Tools/AI/2026-01-30-img-gemini/gemini-error-class.png) <br/>

스스로 만들었던 DataLoader 클래스에서는 변경된 repository 패키지를 수정해주지 않아 여전히 오류가 나는 걸 확인 할 수 있었다. <br>
<br>

![](/assets/img/Tools/AI/2026-01-30-img-gemini/gemini-limit-max.png) <br/>
무료 사용량에 도달하면 이렇게 선택지를 주는 듯 하다. <br><br>


![](/assets/img/Tools/AI/2026-01-30-img-gemini/gemini-final-package.png) <br/>
