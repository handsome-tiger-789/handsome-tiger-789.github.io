...
![](/assets/img/Database/2026-02-02-img-erd-editor/plugin.png) <br/>
...
![](/assets/img/Database/2026-02-02-img-erd-editor/new-erd-file.png) <br/>

프로젝트 내 {파일명}.erd.json 명칭으로 파일을 하나 생성하면 ERD 파일 생성은 끝난다. <br>

<br>

![](/assets/img/Database/2026-02-02-img-erd-editor/editor-file.png) <br/>
...
![](/assets/img/Database/2026-02-02-img-erd-editor/db-select.png) <br/>
...
![](/assets/img/Database/2026-02-02-img-erd-editor/newtable-1.png) <br/>

빈 캔버스에 우클릭이나 위에 나오는 단축키를 활용해 테이블을 그릴 수 있다.<br>
<br>

![](/assets/img/Database/2026-02-02-img-erd-editor/make-user-table.png) <br/>
...
![](/assets/img/Database/2026-02-02-img-erd-editor/user-table-properties-1.png) <br/>
![](/assets/img/Database/2026-02-02-img-erd-editor/user-table-properties-2.png) <br/>

테이블에서 우클릭 하면 테이블의 상세 설정을을 확인할 수 있다. <br>
<br>

![](/assets/img/Database/2026-02-02-img-erd-editor/idx_setting.png) <br/>
![](/assets/img/Database/2026-02-02-img-erd-editor/idx_sql.png) <br/>
...
![](/assets/img/Database/2026-02-02-img-erd-editor/relationship-1.png) <br/>

연관관계를 그려보기 위해 게시글 테이블을 추가하고 <br>
캠퍼스에서 우클릭 하여 알맞는 연관관계 선을 선택한다. <br>
<br>

![](/assets/img/Database/2026-02-02-img-erd-editor/relationship-2.png) <br/>

user_id가 post 테이블에 FK 로 들어가야 하기 때문에 <br>
user 를 먼저 클릭 후 post 를 클릭하면 위와 같은 연관관계 선이 그려진다. <br>
<br>

![](/assets/img/Database/2026-02-02-img-erd-editor/relationship-3.png) <br/>

user 테이블의 PK 컬럼명이 그대로 들어가서 id 컬럼이 2개가 되므로 <br>
컬럼명과 설명을 수정한 뒤 드래그하여 보기좋게 정렬한다. <br>
<br>

![](/assets/img/Database/2026-02-02-img-erd-editor/post-properties-sql.png) <br/>
...
![](/assets/img/Database/2026-02-02-img-erd-editor/commit-diff-view.png) <br/>

커밋 전 변경사항 비교 또한 랜더링된 캔버스로 보기좋게 확인이 가능하다. <br>
<br>


![](/assets/img/Database/2026-02-02-img-erd-editor/final-project-folder.png) <br/>
![](/assets/img/Database/2026-02-02-img-erd-editor/project-git-graph.png) <br/>
