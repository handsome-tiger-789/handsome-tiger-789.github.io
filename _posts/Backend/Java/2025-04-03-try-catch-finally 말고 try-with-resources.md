...
tags: [Java, Exception, ResourceManagement]
...
![](/assets/img/Backend/Java/2025-04-03-try-catch-finally 말고 try-with-resources 이미지/AutoCloseable.png)
<br><br>



자원 해제가 정상적으로 수행되었는지는 `InputStreamReader` 객체내 `close()` 에 브레이크 포인트를 잡고 각 테스트마다 확인하였음<br>
![](/assets/img/Backend/Java/2025-04-03-try-catch-finally 말고 try-with-resources 이미지/자원 해제 실행.png)
<br/><br>
