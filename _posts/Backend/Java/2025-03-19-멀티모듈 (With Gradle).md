...
![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-각 모듈별 프로젝트 구조.png)
...
![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-프로젝트 모듈화 기존.png)
...
![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-멀티모듈 이용시 변화.png)
...
![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-생성(1).png)

프로젝트명과 패키지, 버전 등을 확인한 후 `Gradle`로 설정하여 넘어간다.<br>

![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-생성(2).png)

`Lombok`만 추가 해 준 후 프로젝트를 생성한다.<br>

### **1-2) 프로젝트 구성 – 디렉토리**

![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-생성(3).png)      
프로젝트 생성 직후  <br>

![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-생성(4).png)      
`src` 디렉토리만 삭제<br>
...
![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-생성(5).png)

**New** > **Module** 선택<br>

![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-생성(6).png)

![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-생성(7).png)
...
![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-생성(8).png)

▼

![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-생성(9).png)
...
![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-생성(10).png)


▼

![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-생성(11).png)


프로젝트 모듈 목록에서 자동으로 추가된 `core-module` 삭제<br>

![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-생성(12).png)
...
![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-생성(13).png)


![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-생성(14).png)
...
![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-결과.png)

## 7. 최종 Gradle 조회

위까지 프로젝트 구성을 완료한 후 Gradle 구조를 보면 아래와 같다.<br>

![](/assets/img/Backend/Java/2025-03-19-MultiModule/멀티모듈-gradle 구조.png)
